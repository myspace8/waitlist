      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            We unlock your creative skills and give you the framework to think, create, and launch. Whether you're a seasoned developer or just starting out, our programs are designed to challenge and inspire you to reach your full potential.
          </p>
        </div>
